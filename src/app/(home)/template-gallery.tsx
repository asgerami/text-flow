        ...
        <Carousel>
          <CarouselContent className="-ml-4">
            {templates.map((template) => (
              <CarouselItem
                key={template.id}
                className="basis-1/2 sm:basis-1/3 md:basis-1/4 lg:basis-1/5 xl:basis-1/6 p-4 2xl:basis-[14.285714285714285%] pl-4"
              >
                <div
                  className={cn(
                ...
                >
                  <button
                    ...
                    transition flex flex-col items-center gap-y-4 bg-white"
                  />
